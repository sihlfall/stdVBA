...
Sub testAll()
    ...
    sHaystack = "D-22-4BU - London: London is the capital and largest city of England and the United Kingdom."
    ...
    Test.Assert "MatchAll contains all matches", oMatches.Count = 1
